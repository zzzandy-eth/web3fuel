...
# Create a Blueprint for research page
research_bp = Blueprint('research', __name__, url_prefix='/research')

# WordPress API configuration
WORDPRESS_API_BASE = "https://web3fuel.io/article/wp-json/wp/v2"
WORDPRESS_SITE_URL = "https://web3fuel.io/article"
...
@research_bp.route('/debug/wordpress')
def debug_wordpress():
        ...
        if response.status_code == 200:
            ...
            if posts:
                ...
                <body style="font-family: monospace; padding: 20px;">
                    ...
                    <h2>Quick Tests:</h2>
                    <p><a href="/research/api/posts?debug=true" target="_blank">Test API with Debug</a></p>
                    <p><a href="/research/" target="_blank">View Research Page</a></p>
                </body>
                </html>
                """
            else:
...
# Main research page route
@research_bp.route('/')
def research_index():
    """Main research landing page with all enhancements"""
